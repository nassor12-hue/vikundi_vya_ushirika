<?php
/**
 * Login page for Vikundi vya Ushirika Attendance System
 * Handles user authentication for both Admin and Employer roles using MySQLi
 */
...
if ($_POST) {
    ...
    if (!empty($username) && !empty($password)) {
        ...
        $db_name = "vikundi";
        $db_username = "root";
        $db_password = "12345678"; // Update this to match your MySQL password
